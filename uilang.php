<?php
    ...
    function translateId(){
		...
		$definitions = array(
			...
			"Disable Right-Click and Download Video Button" => "Non aktifkan klik kanan pada video",
			"Login" => "Masuk",
			"Yes" => "Ya",
			"No" => "Tidak",
			...
			"Video File Name (Do not change unless necessary. Only use letters and numbers.)" => "Nama File Video (Jangan diubah kecuali perlu. Hanya gunakan huruf dan angka.)",
